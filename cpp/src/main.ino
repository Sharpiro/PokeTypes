...
void setup()
{
  ...
  // pokeTypesObj = AdjacencyList::Create();
  // pokeTypesObj = new AdjacencyMatrix();
  // Serial.println(sizeof(float));
  // lcd.setCursor(0, 0);
  float temp = get_data_from_matrix(PokeType::GRA, PokeType::FIR);
  // float temp = get_data_from_matrix(PokeType::FIR, PokeType::WAT);
  Serial.print("type: ");
  Serial.println(temp);
